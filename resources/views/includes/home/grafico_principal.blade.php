            ...
            <div class="col-md-6">
                <h3>Inscrições <small> Separadas por gênero</small>
                    @if(Auth::user()->admin == "Master")
                        ...
                        <a href="#" class="dropdown-toggle relatorio" data-ordem="sexo" style="font-size: 14px;" role="button" aria-expanded="false"><i class="fa fa-eye" style="color: #3D276B"></i></a>
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li class="dropdown">
                    ...
                    @if(Auth::user()->admin == "Master")
                        ...
                        <a href="#" class="dropdown-toggle relatorio" data-ordem="faixa" role="button" aria-expanded="false"><i class="fa fa-eye" style="color: #3D276B"></i></a>
