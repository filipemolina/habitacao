<!-- top tiles -->
    <div class="row tile_count">
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> Total de Inscritos</span>
            <div class="count">2500</div>
            <span class="count_bottom"><i class="dourado">4% </i> de aumento</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> Total de Deficientes</span>
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="count dourado">2,500</div>
        ...
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> Insc. no Bolsa Família</span>
        ...
        {{-- <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <span class="count_bottom"><i class="dourado"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
        </div> --}}
    </div>
<!-- /top tiles -->