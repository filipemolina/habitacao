...
return [
    ...
    */
    ...
    'attributes' => [
        'coparticipante.orgao_emissor'          => 'Órgão Emissor do Coparticipante',
        'nome'                                  => "Nome",
        'cpf'                                   => 'CPF',
        ...
        'coparticipante.nome'                   => 'Nome do Coparticipante',
        'coparticipante.cpf'                    => 'CPF do Coparticipante',
        'coparticipante.bolsa_familia'          => 'Bolsa Família do Coparticipante',
        'coparticipante.rg'                     => 'RG do Coparticipante',
        'coparticipante.sexo'                   => 'Sexo do Coparticipantes',
        'coparticipante.necessidades_especiais' => 'Necessidades Especiais do Coparticipante',
        ...
        'tempo_residencia'                      => 'Início da Resiência em Mesquita',
        'name'                                  => 'Nome',
        'email'                                 => 'E-mail',
        'password'                              => 'Senha',
